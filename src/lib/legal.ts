    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          pick(
            locale,
            "Analitik amacıyla Google Analytics (Google Ireland Limited) ve Microsoft Clarity (Microsoft Corporation) hizmetlerinden yararlanılabilir. Bu hizmetler kendi çerezlerini yerleştirir ve verileri kendi gizlilik politikaları kapsamında işler; yalnızca açık rızanızla çalıştırılır.",
            "For analytics we may use Google Analytics (Google Ireland Limited) and Microsoft Clarity (Microsoft Corporation). These services set their own cookies and process data under their own privacy policies; they run only with your explicit consent.",
          ),
        ],
      },
      {
