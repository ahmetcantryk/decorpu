    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          pick(
            locale,
            "Analitik amacıyla Google Analytics (Google Ireland Limited) hizmetinden yararlanılabilir. Bu hizmet, kendi çerezlerini yerleştirir ve verileri Google'ın gizlilik politikası kapsamında işler. Bu çerezler yalnızca açık rızanızla çalıştırılır.",
            "For analytics we may use Google Analytics (Google Ireland Limited). This service sets its own cookies and processes data under Google's privacy policy. These cookies run only with your explicit consent.",
          ),
        ],
      },
      {
